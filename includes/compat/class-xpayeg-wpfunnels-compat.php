 ...
 * fine; only the shopper-facing landing breaks.
 *
 * This plugin feels it twice: the URL is the redirect the checkout
 * response hands the browser after a confirmed payment, AND the session's
 * own afterCompletion redirect. Filtering at the source repairs both call
 * sites at once.
 *
...
final class XPayEG_WPFunnels_Compat {
	...
	const DISMISS_META = 'xpayeg_wpfunnels_notice_dismissed';

	/** Query arg + nonce action of the notice's dismiss link. */
	const DISMISS_ARG = 'xpayeg-dismiss-wpfunnels';
	...
	public static function render_notice(): void {
		...
		$settings_url = admin_url( 'admin.php?page=wc-settings&tab=checkout&section=' . XPayEG_Constants::GATEWAY_ID );
	 ...
	 * survives plugin folder renames.
	 */
