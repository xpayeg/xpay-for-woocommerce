...
class XPay_Api_Exception extends Exception {
	...
	public static function amount_above_line_ceiling(): self {
		return new self( 'Order total is above the amount a line quantity can carry', XPay_Error_Codes::AMOUNT_ABOVE_LINE_CEILING );
	}
	...
	public static function payment_methods_unavailable(): self {
		return new self( 'No enabled XPay payment method can serve this order', XPay_Error_Codes::PAYMENT_METHODS_UNAVAILABLE, 409 );
	}

	/** Secure state or PKCE material could not be generated. */
	public static function connect_randomness_failed(): self {
		return new self( 'Secure Connect flow material could not be generated', XPay_Error_Codes::CONNECT_RANDOMNESS_FAILED );
	}
	...
	public static function refund_currency_unsupported(): self {
		return new self( 'Partial refunds are processed in EGP; this order is priced in another currency', XPay_Error_Codes::REFUND_CURRENCY_UNSUPPORTED );
	}
