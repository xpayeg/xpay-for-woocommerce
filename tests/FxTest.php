<?php
/**
 * The port of the platform's FX conversion (includes/api/class-xpayeg-fx.php).
 *
...
class FxTest extends PHPUnit\Framework\TestCase {
	...
	public function test_a_usd_amount_settles_as_the_platform_settled_it(): void {
		...
		$this->assertSame( 561110, XPayEG_Fx::to_settlement( 11000, '51.01', 'USD', 'EGP' ) );
	}
	...
	public function test_a_kwd_amount_accounts_for_the_extra_decimal(): void {
		...
		$this->assertSame( 1820170, XPayEG_Fx::to_settlement( 110000, '165.47', 'KWD', 'EGP' ) );
	}

	public function test_a_bhd_amount_does_the_same(): void {
		// Live: quantity 110000 BHD at 135.27 answered amountSubtotal 1487970.
		$this->assertSame( 1487970, XPayEG_Fx::to_settlement( 110000, '135.27', 'BHD', 'EGP' ) );
	}
	...
	public function test_a_remainder_is_dropped_not_rounded_down(): void {
		$this->assertSame( 127576, XPayEG_Fx::to_settlement( 2501, '51.01', 'USD', 'EGP' ) );
	}
	...
	public function test_a_remainder_of_exactly_a_half_is_still_dropped(): void {
		$this->assertSame( 130075, XPayEG_Fx::to_settlement( 2550, '51.01', 'USD', 'EGP' ) );
	}
	...
	public function test_the_inverse_truncates_too(): void {
		...
		$this->assertSame( 2500, XPayEG_Fx::to_presentment( 127576, '51.01', 'USD', 'EGP' ) );
	}

	public function test_an_exact_amount_survives_the_round_trip(): void {
		$settlement = XPayEG_Fx::to_settlement( 2500, '51.01', 'USD', 'EGP' );
		$this->assertSame( 127525, $settlement );
		$this->assertSame( 2500, XPayEG_Fx::to_presentment( $settlement, '51.01', 'USD', 'EGP' ) );
	}

	public function test_the_inverse_accounts_for_the_extra_decimal(): void {
		$this->assertSame( 110000, XPayEG_Fx::to_presentment( 1820170, '165.47', 'KWD', 'EGP' ) );
	}

	/* ── Same currency is not a conversion ───────────────────────────── */

	public function test_egp_to_egp_is_the_number_itself(): void {
		$this->assertSame( 24999, XPayEG_Fx::to_settlement( 24999, '1', 'EGP', 'EGP' ) );
		$this->assertSame( 24999, XPayEG_Fx::to_presentment( 24999, '1', 'EGP', 'EGP' ) );
	}
	...
	public function test_an_unusable_rate_answers_nothing( string $rate ): void {
		$this->assertNull(
			XPayEG_Fx::to_settlement( 2500, $rate, 'USD', 'EGP' ),
	...
	public function test_a_long_rate_is_used_in_full(): void {
		$this->assertSame( 127527, XPayEG_Fx::to_settlement( 2500, '51.011', 'USD', 'EGP' ) );
	}
	...
	public function test_an_amount_too_large_to_multiply_answers_nothing(): void {
		$this->assertNull( XPayEG_Fx::to_settlement( PHP_INT_MAX, '51.01', 'USD', 'EGP' ) );
	}

	public function test_zero_is_zero(): void {
		$this->assertSame( 0, XPayEG_Fx::to_settlement( 0, '51.01', 'USD', 'EGP' ) );
	}
}
