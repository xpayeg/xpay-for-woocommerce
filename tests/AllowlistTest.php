 ...
 * URL allowlist tests.
 *
 * Pins the browser-vs-PHP parser differential rejections. Origin: the
 * stress-test audit of 2026-08-17 showed https://evil.com\@xpay.app/ parses
 * to host xpay.app in PHP while a browser (WHATWG treats \ as /) navigates
 * to evil.com — the allowlist is the sole control on API-supplied redirect
 * URLs, so these shapes must fail closed. Runs against a wp_parse_url()
